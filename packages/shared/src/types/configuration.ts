import {IDropdownApiOptions, IDropdownStaticOptions, IGallyProperty} from './hydra'
...
export interface IConfigurationData {
  [key: string]: IConfiguration["value"]
}
...
export interface IConfigurationTreeGroupFormatted extends Omit<IConfigurationTreeGroup, 'fieldsets'> {
  code:string
}
