...
import ConfirmPasswordComponent, {IConfirmPasswordValues} from "./ConfirmPassword";
...
const FormErrorTemplate: ComponentStory<typeof ConfirmPasswordComponent> = (args) => {
  ...
  return <ConfirmPasswordComponent {...args} value={value} onChange={onChange} />
}
