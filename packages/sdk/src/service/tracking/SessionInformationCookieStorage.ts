import {
  ...
  generateUUID,
} from './SessionInformationStorage'
...
class SessionInformationCookieStorage extends SessionInformationStorage {
   ...
   */
  getSessionInformation(): ISessionInformation {
   ...
   */
  private createAndStoreInformation(): ISessionInformation {
    const information: ISessionInformation = {
   ...
   */
  private createAndStoreUid(sessionVid: string): ISessionInformation {
   ...
   */
  private createAndStoreVid(sessionUid: string): ISessionInformation {
...
export { SessionInformationCookieStorage }
